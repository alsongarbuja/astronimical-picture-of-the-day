Astronomical picture a day is a small project showcasing the beautiful astronomical pictures each day using the [NASA API](https://api.nasa.gov/) and [Next.js](https://nextjs.org/).
