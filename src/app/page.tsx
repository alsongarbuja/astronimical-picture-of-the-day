...
export default async function Home() {
  ...
  return (
    <main className="max-w-7xl w-[90%] mx-auto grid grid-cols-3 items-center justify-center border-b-2">
      ...
      <section className="col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
